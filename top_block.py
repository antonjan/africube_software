...
# Title: Top Block
# Generated: Mon Sep 23 13:29:22 2019
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_0.set_sample_rate(250000)
        self.osmosdr_source_0.set_center_freq(435100e3, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_agc_xx_0, 0), (self.blocks_multiply_const_vxx_1_0, 0))    
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.blks2_tcp_sink_0, 0))    
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.blocks_null_sink_0, 0))    
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.wxgui_fftsink2_0, 0))    
